...
class AvailabilitiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create availability" do
    assert_difference('Availability.count') do
      post availabilities_url, params: { availability: { course_id: @availability.course_id, end_time: @availability.end_time, hourly_rate: @availability.hourly_rate, repeat_weekly: @availability.repeat_weekly, start_time: @availability.start_time, user_id: @availability.user_id } }
    end
  ...
  test "should update availability" do
    patch availability_url(@availability), params: { availability: { course_id: @availability.course_id, end_time: @availability.end_time, hourly_rate: @availability.hourly_rate, repeat_weekly: @availability.repeat_weekly, start_time: @availability.start_time, user_id: @availability.user_id } }
